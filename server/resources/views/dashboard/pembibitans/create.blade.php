        ...
        <div class="breadcrumbs-top">
            ...
            <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                    ...
                    <li class="breadcrumb-item active">Tambah Pembibitan
                    </li>
                </ol>
            </div>
        </div>
...
<div class="row">
    <div class="col-8">
        <div class="card">
            <form action="{{ route('dashboard.pembibitans.store') }}" method="POST" enctype="multipart/form-data">
                <div class="card-header">
                    <p class="card-title font-weight-bold">Form Tambah Pembibitan</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group mb-50">
                                ...
                                <img id="createPicture" class="text-center" src="/assets/images/car_model_default.png" alt="foto gambar" style="display: block; width: 150px; height:auto;" />
                            </div>
                            <div class="form-group mb-50">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group mb-50">
                                        ...
                                        <input type="text" name="jenis" class="form-control" placeholder="Masukkan Jenis Bibit" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group mb-50">
                                        ...
                                        <input type="text" name="lama_tanam" class="form-control" placeholder="Masukkan Lama Tanam" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group mb-50">
                                        ...
                                        <input type="text" name="harga" class="form-control" placeholder="Masukkan Harga Bibit" required>
                                    </div>
                                </div>
                            </div>
                        </div>
