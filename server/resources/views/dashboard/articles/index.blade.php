        ...
        <div class="breadcrumbs-top">
            ...
            <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                    ...
                    <li class="breadcrumb-item active">Tabel Artikel
                    </li>
                </ol>
            </div>
        </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <p class="card-title font-weight-bold">Tabel Artikel</p>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ $article->image }}" target="_blank">
                                            <img src="{{ $article->image }}" width="64px" height="64px">
                                        </a>
                                    </td>
                                    <td>{{ $article->title }}</td>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('dashboard.articles.edit', $article->id) }}" class="btn btn-info">Edit</a>
                                            <button class="btn btn-danger deleteButton" value="{{ $article->id }}">Hapus</button>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h5 class="modal-title white">Hapus Artikel</h5>
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title white">Qr Code Artikel</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i class="bx bx-x"></i>
                </button>
            </div>
...
<script>
    $(document).on("click", ".deleteButton", function() {
        ...
        $("#deleteForm").attr("action", "{{ route('dashboard.articles.index') }}/" + id)
        $("#deleteModal").modal();
    });
</script>
@endsection